...
public class TcpManagerProxy
{
    ...
    public void send(final long connectionId, final AtomicBuffer buffer, final int offset, final int length)
    {
        if (!sendWriter.write((int)connectionId, buffer, offset, length))
        {
